 ...
 */
class MageWorkshop_DetailedReview_Adminhtml_Mageworkshop_Detailedreview_UserprosconsController extends Mage_Adminhtml_Controller_Action
{
    ...
    {
        $entityIds = (array) $this->getRequest()->getParam('review_proscons');
    ...
    public function saveAction()
    {
        ...
        if ($data = $this->getRequest()->getPost()) {
            ...
            try {
                ...
                Mage::getSingleton('adminhtml/session')->addSuccess(Mage::helper('catalog')->__('%s has been saved.', $this->_entityName));
