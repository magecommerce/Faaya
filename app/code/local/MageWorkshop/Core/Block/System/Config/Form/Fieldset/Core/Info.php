...
class MageWorkshop_Core_Block_System_Config_Form_Fieldset_Core_Info extends Mage_Adminhtml_Block_System_Config_Form_Fieldset
{
    ...
    protected function _getFieldHtml($fieldset, $moduleName)
    {
        ...
        $systemUrl = '*/system_config/edit/section/';
        $section = $systemUrl. key($xmlData['global']['blocks']);
        $section = (strtolower($moduleName) == strtolower('MageWorkshop_ImportExportReview')) ?  $systemUrl . 'drie' : $section;
