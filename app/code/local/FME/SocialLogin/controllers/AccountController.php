...
class FME_Sociallogin_AccountController extends Mage_Customer_AccountController {  
...
// See if there is a user from a cookie
 ...
 //           'appId'  => '810987928918633',
 //           'secret' => '3703c555fef142aa0994179576d2829d',
 //              ));
 ...
 //                  $check_customer = Mage::helper('sociallogin')->CheckCustomer($user_profile['email']);
                 
 //                  if ($check_customer == $user_profile['email']) {
 ...
 //  }       
    ...
    if (Mage::getStoreConfig('config_options/general_info/module_enable') == 0) 
          {
        ...
        if ($this->getRequest()->isPost()) {
            ...
            if (!empty($login['username']) && !empty($login['password'])) {
                try {
                 ...
                 echo Mage::getUrl('customer/account');
...
public function createPostAction()
 ...
 if (Mage::getStoreConfig('config_options/general_info/module_enable') == 0) 
        ...
        try {
            ...
            if (empty($errors)) {
                $customer->save();
                echo "Customer is successfully registered";
            ...
            if ($e->getCode() === Mage_Customer_Model_Customer::EXCEPTION_EMAIL_EXISTS) {
                ...
                echo 'There is already an account with this email address. If you are sure that it is your email address, <a onclick="return show_login();" href="javascript:void(0);">click here</a> to get your password and access your account.';
            ...
            echo "Cannot save the customer.";
            //$session->setCustomerFormData($this->getRequest()->getPost())
            //  ->addException($e, $this->__('Cannot save the customer.'));
        }
        echo "Error! Cannot Create Account";
        //$errUrl = $this->_getUrl('*/*/create', array('_secure' => true));
        //$this->_redirectError($errUrl);
    }
    ...
    public function forgotPasswordPostAction()
    {
      if (Mage::getStoreConfig('config_options/general_info/module_enable') == 0) 
        ...
        if ($email) {
            ...
            echo "If there is an account associated with email you will receive an email with a link to reset your password.";
           // $this->_redirect('*/*/');
            return;
        } else {
