...
function amshopby_rwd_toggle_content(){
 ...
 jQuery(".am-toggle-content, .toggle-content").removeClass("accordion-open");                    wrapper.removeClass('accordion-open');
                } else {
                    //They're clicking something new. Reflect the explicit user interaction.
jQuery(".am-toggle-content, .toggle-content").removeClass("accordion-open");                    wrapper.addClass('accordion-open');
                }
                var dl = wrapper.children('dl:first');
                var dts = dl.children('dt');
                var panes = dl.children('dd');
