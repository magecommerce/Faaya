	...
	this.getFrameHeight = function()
	{
		if (this.frameHeight == null) {
			...
			if (el && $(el).getHeight() > 50) {
                ...
                //this.frameHeight = 960; // Default orizinal code, edit below line due to load more issue(Height create issue and sometime load more is not displaying)
				this.frameHeight = 1960;
			}
		}
